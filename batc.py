...
@click.option('--conda_env', default=os.getenv('$CONDA_DEFAULT_ENV'), help=f"Conda environment to activate, default is {os.getenv('CONDA_DEFAULT_ENV')}")@click.option('--acc', default=partition_acc_name, help=f'Account name, default = {partition_acc_name}')
